...
func TestValidationExpense(t *testing.T) {
	...
	t.Run("test validation expense model", func(t *testing.T) {
		tests := []testCase{
			...
			{modify: func(e *Expense) { e.Type = -1 }, wantValid: false, wantErr: errors.New("expense:validate:Type required")},
			{modify: func(e *Expense) { e.PaymentMethod = -1 }, wantValid: false, wantErr: errors.New("expense:validate:PaymentMethod required")},
