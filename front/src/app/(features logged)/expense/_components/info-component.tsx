import { FinancialSummaryProps } from "@/app/financialSummaryProps";
...
export function InfoComponent(summaryInfo: Readonly<FinancialSummaryProps>) {
  return (
    <div className="h-full w-full flex flex-col justify-center">
      ...
      <div className="col-span-2 flex flex-col text-start my-3">
      ...
      <div className="col-span-2 flex flex-col text-start my-2">
        <span className="font-display text-sm md:text-3xl">Fatura</span>
        <span className="text-2xl md:text-4xl font-bold font-number text-violet-400">
          {formatCurrency(Number(summaryInfo.invoiceAmount))}
        </span>
      </div>
      <div className="col-span-2 flex flex-col text-start my-2">
        <span className="font-display text-sm md:text-3xl">Variável</span>
        <span className="text-2xl md:text-4xl font-bold font-number text-cyan-400">
          {formatCurrency(Number(summaryInfo.variableAmount))}
        </span>
      </div>
      <div className="col-span-2 flex flex-col text-start my-2">
        <span className="font-display text-sm md:text-3xl">Mensal</span>
        <span className="text-2xl md:text-4xl font-bold font-number text-indigo-400">
          {formatCurrency(Number(summaryInfo.monthlyAmount))}
        </span>
      </div>
      <div className="col-span-2 flex flex-col text-start my-2">
